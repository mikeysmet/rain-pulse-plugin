...
import com.atakmap.android.plugin.rain.pulse.PulseDropDownReceiver;
...
public class PulseTool extends Tool implements ToolDescriptor {

    private final Context context;

    public PulseTool(Context context) {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                PulseDropDownReceiver.SHOW_PLUGIN);
